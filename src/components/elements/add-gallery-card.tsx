...
import FormGallery from '@components/gallery/form-gallery2';
import {
    IGallery, IUIConfig
} from 'src/interfaces';
    ...
    async onFinish(data) {
        try {
            ...
            if (id) {
                ...
                await this.handleUploadPhotos(id);
                ...
                await this.handleUploadPhotos(result.data._id);
